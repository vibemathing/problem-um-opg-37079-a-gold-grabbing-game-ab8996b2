...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37079-a-gold-grabbing-game-ab8996b2-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37079"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37079-a-gold-grabbing-game-ab8996b2-v1",
      "problem_contract_sha256": "0035cf1b965c0a7bd7064c73711952ccf4eb514b0e3dafe9d5fa4c88412ce948",
      "problem_id": "problem:um-opg-37079-a-gold-grabbing-game-ab8996b2",
      "route_id": "route:um-opg-37079-a-gold-grabbing-game-ab8996b2-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37079-a-gold-grabbing-game-ab8996b2-source-fidelity-01",
      "graph_id": "graph:um-opg-37079-a-gold-grabbing-game-ab8996b2-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37079-a-gold-grabbing-game-ab8996b2-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37079-a-gold-grabbing-game-ab8996b2-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Setup Fix a tree $T$ and for every vertex $v \\in V(T)$ a non-negative integer $g(v)$ which we think of as the amount of gold at $v$. 2-Player game Players alternate turns. On each turn, a player chooses a leaf vertex $v$ of the tree, takes the gold at this vertex, and then deletes $v$. The game ends when the tree is empty, and the winner is the player who has accumulated the most gold. Problem Find optimal strategies for the players."
          },
          "statement_sha256": "3cf64def29c7dd93da9d062dc80a6af02c7176f5329ba9e1034eae4ef119cd0b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37079-a-gold-grabbing-game-ab8996b2-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37079-a-gold-grabbing-game-ab8996b2-root",
      "route_id": "route:um-opg-37079-a-gold-grabbing-game-ab8996b2-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37079-acfc37ec3063",
        "url": "https://www.unsolvedmath.com/problems/OPG-37079"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
